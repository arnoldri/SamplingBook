...
*Note*: a **screening sample** is used when we are wanting to sample a population
...
The dataset includes
  ...
  * `Europenan`, Māori`, `Pacific`, `Asian`, `MLAA`, `Other` - counts of students by ethnicity
  ...
  * `Territorial_Aithority`, `Regional_Council`, `Education_Region` - administrative regions
