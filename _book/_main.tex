...
We'll use data from the \texttt{starwars} dataset (in the dplyr package). There
...
We can \textbf{estimate} it from a sample of characters. For the purposes of this exercise let's imagine
...
\begin{eqnarray}
    ...
    &=& 
    180.3 \pm 1.96 \times \frac{31.1}{\sqrt{20}}\\
    &=& 
    180.3 \pm 1.96 \times 7.0\\
    &=& 
    180.3 \pm 13.6\\
    &=& 
    (166.7,193.9)
