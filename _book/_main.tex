...
\]
(This is 1 minus the chance that a unit is not selected on each of the \(n\) sampling occasions.)

If \(n\) is tiny compared to \(N\), \(p_i\) is approximately \(n/N\) which is the SRSWOR selection
probability. In practice we assign a weight of \(N/n\) to each unit as it is selected, so a unit
that is selected \(m\) times ends up with a weight of \(mN/n\).

If we use weights calculated in this way we have what is known as the Hansen-Hurwitz estimator,
rather than the Horwitz-Thompson estimator. However this distinction need not concern us.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pop[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{10}\NormalTok{,] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kbl}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable\_styling}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
## 1    Bangladesh  BGD 2023  171466986 0.021197666  236        1   23.6
## 2        Brazil  BRA 2023  211140731 0.026102347  236        1   23.6
## 3         India  IND 2023 1438069597 0.177781857  236        2   47.2
## 4     Indonesia  IDN 2023  281190068 0.034762221  236        1   23.6
## 5         Japan  JPN 2023  124370947 0.015375402  236        1   23.6
## 6      Pakistan  PAK 2023  247504505 0.030597831  236        1   23.6
## 7  South Africa  ZAF 2023   63212386 0.007814653  236        1   23.6
## 8 United States  USA 2023  343477330 0.042462505  236        2   47.2
\end{verbatim}
...
\[
   w_i = \frac{N}{n}
\]
Data from this design are often analysed as if they were drawn as a SRSWOR, but in fact this is a special case of
a one-stage cluster sample (S1C, see below).
...
After setting your random starts location you can skip down the list at
fixed intervals.
...
\begin{table}
\centering
\caption{\label{tab:unnamed-chunk-76}Sample of airports (SRSWOR)}
\centering
\begin{tabular}[t]{l|r|l|l|l|l|r|r|r}
\hline
  & ID & IATA & Name & City & Country & Latitude & Longitude & weight\\
\hline
5304 & 5304 & VAO & Suavanao Airport & Suavanao & Solomon Islands & -7.58556 & 158.73100 & 1214.4\\
\hline
4746 & 4746 & STV & Surat Airport & Surat & India & 21.11410 & 72.74180 & 1214.4\\
\hline
1714 & 1714 & GIB & Gibraltar Airport & Gibraltar & Gibraltar & 36.15120 & -5.34966 & 1214.4\\
\hline
1638 & 1638 & FYN & Fuyun Koktokay Airport & Fuyun & China & 46.80417 & 89.51201 & 1214.4\\
\hline
5277 & 5277 & UTO & Indian Mountain LRRS Airport & Indian Mountains & United States & 65.99280 & -153.70399 & 1214.4\\
\hline
\end{tabular}
\end{table}
...
\FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{table}\NormalTok{(samp}\SpecialCharTok{$}\NormalTok{Education\_Region)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{rename}\NormalTok{(}\AttributeTok{Education\_Region=}\NormalTok{Var1, }\AttributeTok{SampleSize=}\NormalTok{Freq)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##                   Education_Region SampleSize
## 1          Bay of Plenty, Waiariki         10
## 2      Canterbury, Chatham Islands         10
## 3          Hawke's Bay, Tairāwhiti         10
## 4  Nelson, Marlborough, West Coast         10
## 5                 Otago, Southland         10
## 6                      Tai Tokerau         10
## 7            Tāmaki Herenga Manawa         10
## 8           Tāmaki Herenga Tāngata         10
## 9              Tāmaki Herenga Waka         10
## 10   Taranaki, Whanganui, Manawatū         10
## 11                         Waikato         10
## 12                      Wellington         10
\end{verbatim}
...
\begin{verbatim}
##                   Education_Region SampleSize
## 1          Bay of Plenty, Waiariki          9
## 2      Canterbury, Chatham Islands         14
## 3          Hawke's Bay, Tairāwhiti          8
## 4  Nelson, Marlborough, West Coast          6
## 5                 Otago, Southland         11
## 6                      Tai Tokerau          7
## 7            Tāmaki Herenga Manawa          9
## 8           Tāmaki Herenga Tāngata          9
## 9              Tāmaki Herenga Waka          9
## 10   Taranaki, Whanganui, Manawatū         11
## 11                         Waikato         13
## 12                      Wellington         13
\end{verbatim}
...
## 2      Canterbury, Chatham Islands         10
## 3          Hawke's Bay, Tairāwhiti         10
## 4  Nelson, Marlborough, West Coast          8
## 5                 Otago, Southland         10
## 6                      Tai Tokerau          9
## 7            Tāmaki Herenga Manawa         10
## 8           Tāmaki Herenga Tāngata          9
## 9              Tāmaki Herenga Waka         10
## 10   Taranaki, Whanganui, Manawatū          9
## 11                         Waikato         10
## 12                      Wellington         10
\end{verbatim}
...
\caption{One Stage Cluster Sample (STSRS)}\label{fig:s1c}
\end{figure}
...
\caption{Two Stage Cluster Sample (STSRS)}\label{fig:s2c}
\end{figure}

\section{Complex multistage designs}\label{complex-multistage-designs}

\section{Introduction to the design effect}\label{introduction-to-the-design-effect}
